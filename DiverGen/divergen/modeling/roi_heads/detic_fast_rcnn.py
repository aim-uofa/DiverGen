...
class DeticFastRCNNOutputLayers(FastRCNNOutputLayers):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.divergen_box_loss=divergen_box_loss
        self.debug = debug
    ...
    def from_config(cls, cfg, input_shape):
        ...
        ret.update({
            ...
            'divergen_box_loss': cfg.MODEL.USE_DIVERGEN_BOX_LOSS
        })
    ...
    def losses(self, predictions, proposals, \
        ...
        ) if not self.divergen_box_loss else None
        return {
            "loss_cls": loss_cls, 
