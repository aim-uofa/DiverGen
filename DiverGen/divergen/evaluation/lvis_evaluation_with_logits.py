...
from .coco_evaluation_with_logits import instances_to_coco_json_with_logits
from .evaluator import DatasetEvaluator


class LVISEvaluatorWithLogits(DatasetEvaluator):
    """
    ...
    def process(self, inputs, outputs):
        ...
        for input, output in zip(inputs, outputs):
            ...
            if "instances" in output:
                ...
                prediction["instances"] = instances_to_coco_json_with_logits(instances, input["image_id"])
    ...
    def evaluate(self):
        ...
        if len(predictions) == 0:
            self._logger.warning("[LVISEvaluatorWithLogits] Did not receive valid predictions.")
            return {}
